...
const Analysis = () => {
  ...
  useEffect(() => {
    ...
    const fetchAnalysisData = async () => {
      try {
        // Obtener datos de análisis del barrio
        const response = await axios.get(`/api/analysis/${neighborhood}`);
  ...
  const displayData = analysisData || mockData;
              ...
              >
                <CardContent>
                  ...
                  <Typography variant="body2">
                    Rango: {formatPrice(displayData.priceRange.min)} - {formatPrice(displayData.priceRange.max)}
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
